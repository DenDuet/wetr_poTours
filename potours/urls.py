...
urlpatterns = [
    ...
    path('tours/', views.group_tours_page, name='tours'),
    path('tours/<int:pk>/', views.redirect_tour_to_inspiration),
    path('group-tours/', views.tours_list, name='group_tours_page'),
